---
name: ultraplan
description: "Use when the user says ultraplan, invokes $ultraplan, wants a thorough plan before coding, needs architectural decisions, asks for a grounded implementation plan, or faces a complex multi-file implementation task."
---
...
**Read-only rule:** Do not create, modify, or delete files except `.ultraplan/plan.md` while planning. Do not install dependencies, run migrations, commit, push, format, or edit implementation files. Read commands, searches, tests, and build checks are allowed when they improve the plan and do not intentionally modify tracked source.
