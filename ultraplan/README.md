# UltraPlan Codex Skill

`ultraplan` is a Codex-native adaptation of the upstream UltraPlan skill by
...
| Claude slash command | Invoke as `$ultraplan`, through the skills picker, or by saying `ultraplan`. |
