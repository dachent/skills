...
- This is an original Codex skill for navigating SART's public clinic-report workflow.
...
Load `references/sart-query-patterns.md` for reusable search templates and worked examples.
