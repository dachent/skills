...
`grill-me` is a Codex-native adaptation of Matt Pocock's upstream
`grill-me` skill. It gives Codex a focused interview mode for stress-testing a
...
- trigger phrases: `$grill-me`, `grill me`, and stress-test language;
