# Repo Map Codex Skill

`repo-map` creates a durable project map and evidence catalog before planning or execution. It is a companion skill for `deep-planning-orchestrator`, but it can also be used directly when Codex needs grounded context for an unfamiliar project.
