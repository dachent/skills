...
| Claude slash command UX | Invoke as `$ultraplan-codex`, via the skills picker, or by using "ultraplan" in the prompt. |
...
- Triggering: `$ultraplan-codex`, plain "ultraplan", implicit complex planning prompts, and app metadata.
