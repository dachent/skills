# Adversarial Plan Review Codex Skill

`adversarial-plan-review` red-teams a plan before execution. It is a companion skill for `deep-planning-orchestrator`, and it can also be used directly when a plan needs hostile review for stale assumptions, missing validation, rollback gaps, sequencing errors, stakeholder risks, or unsafe execution.
