# Grill With Docs Codex Skill

`grill-with-docs` is a Codex-native adaptation of Matt Pocock's upstream
...
- trigger phrases: `$grill-with-docs`, docs-backed grilling, and domain-language
  stress testing;
